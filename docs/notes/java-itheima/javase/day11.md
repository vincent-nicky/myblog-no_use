...
+ StudentController类  和用户打交道(接收用户需求,采集用户信息,打印数据到控制台)
  ...
  ![01_黑马信息管理系统分类](https://github.com/Charon-33/blogImage/raw/master/1-Java/1-JavaSE/6-day11/01_黑马信息管理系统分类.png)
...
+ 同一个包下的访问
  ...
  <font color='orange'>不需要导包，直接使用即可</font>
...
![02_黑马信息管理系统介绍](https://github.com/Charon-33/blogImage/raw/master/1-Java/1-JavaSE/6-day11/02_黑马信息管理系统介绍.png)
...
+ 添加功能实现步骤
  ...
  ![03_添加功能需求分析](https://github.com/Charon-33/blogImage/raw/master/1-Java/1-JavaSE/6-day11/03_添加功能需求分析.png)


+ 添加功能优化:判断id是否存在

  ![04_判断id是否存在](https://github.com/Charon-33/blogImage/raw/master/1-Java/1-JavaSE/6-day11/04_判断id是否存在.png)

+ 查询功能实现步骤

  ![05_查询功能需求分析](https://github.com/Charon-33/blogImage/raw/master/1-Java/1-JavaSE/6-day11/05_查询功能需求分析.png)

+ 删除功能实现步骤

  ![06_删除功能需求分析](https://github.com/Charon-33/blogImage/raw/master/1-Java/1-JavaSE/6-day11/06_删除功能需求分析.png)

+ 修改功能实现步骤

  ![07_修改功能需求分析](https://github.com/Charon-33/blogImage/raw/master/1-Java/1-JavaSE/6-day11/07_修改功能需求分析.png)
...
+ 添加功能实现步骤
  ...
  ![10_添加老师功能实现步骤](https://github.com/Charon-33/blogImage/raw/master/1-Java/1-JavaSE/6-day11/10_添加老师功能实现步骤.png)

+ 查询功能实现步骤

  ![11_查询老师功能实现步骤](https://github.com/Charon-33/blogImage/raw/master/1-Java/1-JavaSE/6-day11/11_查询老师功能实现步骤.png)

+ 删除功能实现步骤

  ![12_删除老师功能实现步骤](https://github.com/Charon-33/blogImage/raw/master/1-Java/1-JavaSE/6-day11/12_删除老师功能实现步骤.png)

+ 修改功能实现步骤

  ![13_修改老师功能实现步骤](https://github.com/Charon-33/blogImage/raw/master/1-Java/1-JavaSE/6-day11/13_修改老师功能实现步骤.png)
...
![image-20230310063822350](https://s2.loli.net/2023/03/12/5lEXT2L1Pz3VgKU.png)

### 5.3static关键字注意事项 (理解)

+ 静态方法只能访问静态的成员
+ 非静态方法可以访问静态的成员，也可以访问非静态的成员
+ 静态方法中是没有this关键字（this在创建对象之后，static在创建对象之前）